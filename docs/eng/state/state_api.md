...
> [Tiếng Việt](../../vi/state/state_api.md)
...
public:
    void OnEnter() override {
        ...
        LoadScene("assets/scenes/my_level.axs");
...
```
Loads an `.axs` or `.axsb` file and adds its entities to the current scene.

**Example:**
```cpp
void OnEnter() override {
    LoadScene("assets/scenes/level_01.axs");
}
```
...
**Example:**
```cpp
    UnloadScene("assets/scenes/ui_overlay.axs");
```
...
void OnUpdate(float dt) override {
    if (m_LevelComplete) {
        ChangeScene("assets/scenes/next_level.axs");
    }
}
```
...
class MenuState : public State {
    void OnEnter() override {
        LoadScene("assets/scenes/main_menu.axs");
...
class PauseState : public State {
    void OnEnter() override {
        LoadScene("assets/scenes/pause_menu.axs");
    ...
    void OnExit() override {
        ...
        UnloadScene("assets/scenes/pause_menu.axs");
...
public:
    ...
    void OnEnter() override {
        LoadScene("assets/scenes/loading_screen.axs");
...
class CutsceneState : public State {
    void OnEnter() override {
        LoadScene("assets/scenes/cutscene_01.axs");
