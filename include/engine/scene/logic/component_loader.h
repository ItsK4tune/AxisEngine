...
using ComponentLoaderFunc = std::function<void(Scene &, entt::entity, const YAMLNode &, ResourceManager &, IPhysicsWorld *)>;
...
public:
    ...
    static bool Load(const std::string& type, Scene &scene, entt::entity entity, const YAMLNode &node, ResourceManager &res, IPhysicsWorld *phys);
