...
{
public:
    static entt::entity CreateEntity(Scene& scene, const std::string& name = "unnamed",
                                     const std::string& tag = "default");
    static entt::entity CreateEntityWithTransform(Scene& scene, const std::string& name, const glm::vec3& position,
    ...
    static entt::entity FindByNameTagAndScene(Scene& scene, const std::string& name, const std::string& tag,
