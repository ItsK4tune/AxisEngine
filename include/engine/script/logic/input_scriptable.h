...
public:
    ...
    bool& GetLeftPressedRef()
    {
        return m_LeftPressed;
    }
    float& GetLeftHoldTimeRef()
    {
        return m_LeftHoldTime;
    }

    bool& GetRightPressedRef()
    {
        return m_RightPressed;
    }
    float& GetRightHoldTimeRef()
    {
        return m_RightHoldTime;
    }

    bool& GetMiddlePressedRef()
    {
        return m_MiddlePressed;
    }
    float& GetMiddleHoldTimeRef()
    {
        return m_MiddleHoldTime;
    }

    const std::vector<KeyBinding>& GetKeyBindings() const
    {
