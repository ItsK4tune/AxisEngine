...
public:
    ...
    static GLenum ToGL(TextureType t)
    {
        switch (t)
        {
            ...
            case TextureType::CubeMapPositiveX:
                return GL_TEXTURE_CUBE_MAP_POSITIVE_X;
            case TextureType::CubeMapNegativeX:
                return GL_TEXTURE_CUBE_MAP_NEGATIVE_X;
            case TextureType::CubeMapPositiveY:
                return GL_TEXTURE_CUBE_MAP_POSITIVE_Y;
            case TextureType::CubeMapNegativeY:
                return GL_TEXTURE_CUBE_MAP_NEGATIVE_Y;
            case TextureType::CubeMapPositiveZ:
                return GL_TEXTURE_CUBE_MAP_POSITIVE_Z;
            case TextureType::CubeMapNegativeZ:
    ...
    {
        GLbitfield flags = 0;
        if ((b & BufferBit::Color))
            flags |= GL_COLOR_BUFFER_BIT;
        if ((b & BufferBit::Depth))
            flags |= GL_DEPTH_BUFFER_BIT;
        if ((b & BufferBit::Stencil))
    ...
    static GLenum ToGL(ServerCapability c)
    {
        switch (c)
        {
            case ServerCapability::Blend:
                return GL_BLEND;
            case ServerCapability::CullFace:
                return GL_CULL_FACE;
            case ServerCapability::DepthTest:
                return GL_DEPTH_TEST;
            case ServerCapability::StencilTest:
                return GL_STENCIL_TEST;
            case ServerCapability::ScissorTest:
                return GL_SCISSOR_TEST;
            case ServerCapability::Multisample:
    ...
    static GLenum ToGL(FramebufferAttachment a)
    {
        switch (a)
        {
            case FramebufferAttachment::None:
                return GL_NONE;
    ...
    static GLbitfield ToGL(MemoryBarrierBit b)
    {
        switch (b)
        {
            case MemoryBarrierBit::ShaderImageAccess:
                return GL_SHADER_IMAGE_ACCESS_BARRIER_BIT;
            case MemoryBarrierBit::VertexAttribArray:
                return GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT;
            case MemoryBarrierBit::ElementArray:
                return GL_ELEMENT_ARRAY_BARRIER_BIT;
            case MemoryBarrierBit::Uniform:
                return GL_UNIFORM_BARRIER_BIT;
            case MemoryBarrierBit::TextureFetch:
                return GL_TEXTURE_FETCH_BARRIER_BIT;
            case MemoryBarrierBit::BufferUpdate:
                return GL_BUFFER_UPDATE_BARRIER_BIT;
            case MemoryBarrierBit::FrameBuffer:
                return GL_FRAMEBUFFER_BARRIER_BIT;
            case MemoryBarrierBit::All:
    ...
    static GLenum ToGL(QueryType t)
    {
        switch (t)
        {
            ...
            case QueryType::AnySamplesPassedConservative:
