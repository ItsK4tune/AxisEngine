...
public:
    ...
    const std::vector<RenderItem>& GetDeferredOpaqueQueue() const { return m_DeferredOpaqueQueue; }
    const std::vector<RenderItem>& GetForwardOpaqueQueue() const { return m_ForwardOpaqueQueue; }
