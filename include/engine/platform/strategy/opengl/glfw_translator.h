...
public:
    static Key ToInputKey(int glfwKey) {
        switch (glfwKey) {
    ...
    static Mouse ToInputMouse(int glfwButton) {
        switch(glfwButton) {
    ...
    static int ToGLFWMouse(Mouse button) {
        switch(button) {
            ...
            case Mouse::Button4: return GLFW_MOUSE_BUTTON_4;
            case Mouse::Button5: return GLFW_MOUSE_BUTTON_5;
            case Mouse::Button6: return GLFW_MOUSE_BUTTON_6;
            case Mouse::Button7: return GLFW_MOUSE_BUTTON_7;
            case Mouse::Button8: return GLFW_MOUSE_BUTTON_8;
    ...
    static int ToGLFWCursorMode(CursorMode mode) {
        switch(mode) {
            ...
            case CursorMode::LockedHidden: return GLFW_CURSOR_DISABLED;
            case CursorMode::Locked: return GLFW_CURSOR_NORMAL;
