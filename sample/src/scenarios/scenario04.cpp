...
void SampleState::LoadScene4()
{
    ...
    m_S4DeferredCubeEntity =
        EntityBuilder(scene, res, "scenario")
            ...
            .Build();
    {
        Entity r(m_S4DeferredCubeEntity, &scene);
        r.SetReceiveShadow(false);
        r.SetCastShadow(true);
        r.SetColor(glm::vec4(0.18f, 0.46f, 1.0f, 1.0f));
    }
    ...
    m_S4DeferredSphereEntity = EntityBuilder(scene, res, "scenario")
                                    ...
                                    .Build();
    {
        Entity r(m_S4DeferredSphereEntity, &scene);
        r.SetReceiveShadow(false);
        r.SetCastShadow(true);
        r.SetColor(glm::vec4(0.10f, 0.70f, 1.0f, 1.0f));
    }
    ...
    m_S4ForwardCubeEntity =
        EntityBuilder(scene, res, "scenario")
            ...
            .Build();
    {
        Entity r(m_S4ForwardCubeEntity, &scene);
        r.SetRenderMode(RenderMode::ForceForward);
        r.SetReceiveShadow(false);
        r.SetCastShadow(true);
        r.SetColor(glm::vec4(1.0f, 0.18f, 0.14f, 1.0f));
    }
    ...
    m_S4ForwardSphereEntity =
        EntityBuilder(scene, res, "scenario")
            ...
            .Build();
    {
        Entity r(m_S4ForwardSphereEntity, &scene);
        r.SetRenderMode(RenderMode::ForceForward);
        r.SetReceiveShadow(false);
        r.SetCastShadow(true);
        r.SetColor(glm::vec4(1.0f, 0.36f, 0.22f, 1.0f));
    }
    ...
    m_S4LightEntity =
        EntityBuilder(scene, res, "scenario")
            ...
            .Build();
    Entity(m_S4LightEntity, &scene).SetLightCastShadow(true);
}
