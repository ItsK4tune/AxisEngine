...
void SampleState::LoadScene3()
{
    ...
    auto point = EntityBuilder(scene, res, "scenario")
                     ...
                     .Build();
    Entity(point, &scene).SetLightCastShadow(true);
    ...
    auto spot = EntityBuilder(scene, res, "scenario")
                    ...
                    .Build();
    Entity spotEnt(spot, &scene);
    spotEnt.SetSpotLightCutOff(22.5f, 32.5f);
    spotEnt.SetLightAttenuation(0.045f, 0.0075f);
    spotEnt.SetRotation(RotationFromNegativeY(
        glm::normalize(glm::vec3(0.0f, 1.0f, 0.0f) - glm::vec3(m_S3SpotOrbitRadius, m_S3SpotMotionHeight, 0.0f))));
    spotEnt.SetLightCastShadow(true);
