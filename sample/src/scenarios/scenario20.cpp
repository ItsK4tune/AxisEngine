...
void SampleState::LoadScene20()
{
    ...
    m_S20PlanarMirror = planarMirror;
    ...
    const CaseDef cases[] = {
        ...
        {"Mid", "CenterProbe", "ReflectiveMid", glm::vec3(-2.0f, 6.0f, 0.0f), glm::vec4(0.85f, 0.85f, 0.9f, 1.0f),
         m_S20ProbeResolution, m_S20Reflectivity, m_S20FresnelBias, m_S20FresnelPower},
    ...
    for (const auto& c : cases)
    {
        ...
        m_S20ReflectionProbes.push_back(probeEntity);
        ...
        m_S20ReflectionSpheres.push_back(sphere);
    }
}
