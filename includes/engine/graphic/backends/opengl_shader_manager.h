...
{
public:
    unsigned int CreateShader(Graphics::ShaderType type) override { return glCreateShader(GLTranslator::ToGL(type)); }
    ...
    void MemoryBarrier(Graphics::MemoryBarrierBit barriers) override { glMemoryBarrier(GLTranslator::ToGL(barriers)); }
