...
void DebugDrawer::Flush()
{
    ...
    // Resize buffer if needed, or orphan it
...
{
    // Draw a small line representing normal
    btVector3 to = PointOnB + normalOnB * 1.0f; // Scale normal for visibility
...
{
    // Not implemented for now (needs font system integration)
}
