...
entt::entity EntityManager::FindByNameTagAndScene(Scene& scene, const std::string& name, const std::string& tag,
...
entt::entity EntityManager::CreateEntityWithTransform(Scene& scene, const std::string& name, const glm::vec3& position,
