...
bool InputLoader::LoadBindings(const std::string &filepath, InputManager &inputManager)
{
    ...
    static std::unordered_map<std::string, Gamepad> gamepadMap = {
        {"buttona", Gamepad::ButtonA}, {"cross", Gamepad::Cross}, {"buttonb", Gamepad::ButtonB}, {"circle", Gamepad::Circle}, {"buttonx", Gamepad::ButtonX}, {"square", Gamepad::Square}, {"buttony", Gamepad::ButtonY}, {"triangle", Gamepad::Triangle}, {"buttondpadup", Gamepad::ButtonDpadUp}, {"buttondpaddown", Gamepad::ButtonDpadDown}, {"buttondpadleft", Gamepad::ButtonDpadLeft}, {"buttondpadright", Gamepad::ButtonDpadRight}, {"buttonrightbumper", Gamepad::ButtonRightBumper}, {"buttonleftbumper", Gamepad::ButtonLeftBumper}, {"buttonrightthumb", Gamepad::ButtonRightThumb}, {"buttonleftthumb", Gamepad::ButtonLeftThumb}, {"buttonstart", Gamepad::ButtonStart}};
