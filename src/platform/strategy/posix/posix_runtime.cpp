...
const char* PosixRuntime::GetName() const
{
    return "POSIX";
}

void PosixRuntime::DetachConsole()
{
}

void PosixRuntime::InstallCrashHandler(CrashReportCallback callback)
{
...
std::tm PosixRuntime::LocalTime(std::time_t time) const
{
    std::tm result{};
